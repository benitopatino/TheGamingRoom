...
public class ProgramDriver {
	...
	public static void main(String[] args) {
		...
		GameService service = GameService.getReference(); // replace null with ???
//
		...
		System.out.println(service.getGame(0).addTeam("Blue Team").addPlayer("Hugh").toString());
